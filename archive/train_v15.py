...
from project_dataset_triplet_v15 import ProjectDataset
...
parser.add_argument('--model_version_string', type=str, default="coconut_model_v15")
...
def get_data_loader():
    ...
    data_set = ProjectDataset(anchor_file="data/triplet_encode/triple_sentence0_encode.npy",
...
def batch_eval(batch, model):
    ...
    # anchor_feature = F.normalize(anchor_feature, dim=1, p=2)
...
def train():
    ...
    # print(coconut_model.fc1.weights)
