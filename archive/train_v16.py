...
from models.coconut_model_v16 import CoconutModel
...
parser.add_argument('--model_version_string', type=str, default="coconut_model_16")
...
def get_data_loader():
    ...
    train_set = ProjectDataset(file_path="data/cwb_pair/paired_sentences_train.csv")
    valid_set = ProjectDataset(file_path="data/cwb_pair/paired_sentences_dev.csv")
